...
</button>`,g={__name:"buttons",setup(b){return o(()=>{Prism.highlightAll()}),(d,c)=>(e(),s(n,{class:"column gap-5"},{default:l(()=>[t("article",null,[r,i,t("pre",{class:"border"},[t("code",{class:"language-html"},a(u))])])]),_:1}))}};export{g as default};
