...
</table>`,C={__name:"table",setup(n){return a(()=>{Prism.highlightAll()}),(f,y)=>(h(),r(u,null,{default:o(()=>[t("article",{id:"table",class:"column"},[p,i,t("pre",{class:"border"},[t("code",{class:"language-html"},s(m))])])]),_:1}))}},w=e(C,[["__scopeId","data-v-2b9d4abe"]]);export{w as default};
