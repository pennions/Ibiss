...
<a href class="button danger disabled">A link as button with the disabled class</a>`,k={__name:"links",setup(t){return l(()=>{Prism.highlightAll()}),(p,A)=>(r(),o(s,{class:"flex-100 column gap-5"},{default:c(()=>[a("article",null,[u,b,a("pre",{class:"border"},[a("code",{class:"language-html"},i(f))])])]),_:1}))}},g=e(k,[["__scopeId","data-v-92d542c7"]]);export{g as default};
