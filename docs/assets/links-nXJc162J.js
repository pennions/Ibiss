...
<a href class="button danger disabled">A link as button with the disabled class</a>`,k={__name:"links",setup(t){return l(()=>{Prism.highlightAll()}),(p,A)=>(r(),o(s,{class:"column gap-5"},{default:c(()=>[a("article",null,[u,b,a("pre",{class:"border"},[a("code",{class:"language-html"},i(f))])])]),_:1}))}},g=e(k,[["__scopeId","data-v-15c0d09f"]]);export{g as default};
