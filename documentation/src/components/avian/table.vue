  ...
  <Card>
    <article id="table"
      ...
      <div class="body column no-stretch gap-3">
        <p>Utility classes to add to the <code>&lt;table/&gt;</code> element:</p>
        <table class="table mb-5">
          ...
          <tbody>
            <tr>
              <td>align-top</td>
              <td>Default, applies <code>vertical-align: top</code></td>
            </tr>
            <tr>
              <td>align-middle</td>
              <td>Applies <code>vertical-align: middle</code></td>
            </tr>
            <tr>
              <td>align-bottom</td>
              <td>Applies <code>vertical-align: bottom</code></td>
            </tr>
          </tbody>
        </table>
        <p>
          You can also apply <code>.table-container</code> to an element around the table, like a
          <code>&lt;div/&gt;</code>.<br /> This will add a border and makes it scrollable. See example below
        </p>
        <hr />
