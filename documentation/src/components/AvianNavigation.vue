...
<template>
  <section class="bg-white">
    <div class="column align-center gap-1 mb-3">
    ...
    <nav class="font-size-18">
      <h2>Base</h2>
      <hr />
      <ul class="ml-0 mt-3 list-style-none">
        <li class="my-1 ml-1"><router-link to="/typography">Typography</router-link></li>
        <li class="mb-1 ml-1"><router-link to="/variables">Variables</router-link></li>
      </ul>
      ...
      <ul class="ml-0 list-style-none">
        ...
        <li class="mb-1 ml-1"><router-link to="/cursors">Cursors</router-link></li>
      </ul>
    </nav>
  </section>
</template>
